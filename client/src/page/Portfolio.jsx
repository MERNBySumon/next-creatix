  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      >
        ...
        <div className="relative z-10 space-y-4 px-4">
          ...
          <p className="text-gray-300 text-base sm:text-lg md:text-xl max-w-2xl mx-auto">
            “Our portfolio showcases a blend of creativity, technology, and
            vision—highlighting projects that reflect our passion for crafting
            memorable digital experiences with real-world impact.”
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-10 bg-gray-50">
        <h2 className="text-3xl font-bold text-center text-[#001133] mb-5">
          <span className="text-[#ff9000]">Featured</span> Works
        </h2>
        <p className="text-center mb-8">“Where Creativity Meets Purpose.”</p>
          ...
          {currentItems.map((item) => (
            ...
            >
              ...
              <div className="p-5">
                ...
                <p className="text-sm text-gray-500"> Book Covers</p>
              </div>
            </div>
          ))}
        </div>
